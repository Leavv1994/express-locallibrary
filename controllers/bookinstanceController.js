...
exports.bookinstance_detail = function(req, res, next) {
    ...
    //populate lets you pull in referenced documents from another collection to use its data
    //allows us to consolidate information from various collections into one result
    .populate('book')
...
exports.bookinstance_delete_get = function(req, res) {
  ...
  BookInstance.findById(req.params.id)
    ...
    .exec(function(err, bookinstance) {
      if(err) {return next(err);    }
      //If no error, then successful and render
